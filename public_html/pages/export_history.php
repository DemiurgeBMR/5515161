...
// Контрагент — то, что реально интересно смотрящему: собственнику интересен
// оператор, оператору интересен собственник. Своё же имя в каждой строке —
// чистый информационный мусор, поэтому в экспорт идёт только одна колонка.
$counterpartLabel = ($role === 'owner') ? 'Оператор' : 'Собственник';
