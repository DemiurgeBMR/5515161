        ...
        <div class="hiw-container">
            ...
            <div class="hiw-columns">
                <div class="hiw-column<?php echo $role === 'owner' ? ' hiw-column-active' : ''; ?>">
                    <div class="hiw-column-header">
                        ...
                        <div>
                            <h2>Собственникам площадей</h2>
                            <p>Сдайте свободное место под вендинг и получайте доход с аренды</p>
                        </div>
                    </div>
                    <ol class="hiw-steps">
                        <li>
                            <strong>Зарегистрируйтесь как собственник.</strong>
                    ...
                    <?php if (!$isLoggedIn): ?>
                        <a href="/pages/register.php?role=owner" class="btn-contact btn-block">Стать собственником</a>
                ...
                <div class="hiw-column<?php echo $role === 'operator' ? ' hiw-column-active' : ''; ?>">
                    ...
                    <ol class="hiw-steps">
                        ...
                        <li>
                            ...
                            адрес, имя собственника и возможность написать ему напрямую.
                        </li>
                        <li>
                            <strong>Напишите собственнику.</strong>
                        ...
                        <li>
                            ...
                            После подтверждения собственником точка закрепляется за вами.
                        </li>
                        <li>
            ...
            <div class="hiw-faq">
                ...
                <div class="hiw-faq-item">
                    ...
                    <div class="hiw-faq-a">Нет, добавление локаций для собственников бесплатно.</div>
                </div>
                <div class="hiw-faq-item">
                    <div class="hiw-faq-q">Зачем нужна подписка?</div>
                    <div class="hiw-faq-a">
                        Подписка — на стороне оператора. Она открывает точный адрес и имя собственника
                ...
                <div class="hiw-faq-item">
                    <div class="hiw-faq-q">Что если собственник передумал сдавать место оператору?</div>
                    <div class="hiw-faq-a">
                        Собственник может отклонить запрос на закрепление или в любой момент открепить
